...
fn main() {
    ...
    let request = match args.as_slice() {
        [command, input, output, directory, page] if command == "render-pdf-page" => {
            let page_index = page
                .to_str()
